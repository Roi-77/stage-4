      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center lg:items-start gap-2">
            ...
            <div className="flex items-center gap-4 text-sm text-slate-600 bg-white/50 px-4 py-2 rounded-2xl">
              <span>⏳
        ...
        <NewTaskModal isOpen={showModal} onClose={() => setShowModal(false)} onAdd={handleAddTask} />
      </div>
    </header>
  );
};
